...
test-uvdb-core-integration$(HOST_EXEEXT): src/uvdb.c tests/host/test_uvdb_core_integration.c tests/host/uvdb_host_platform.h src/uvdb_rsp.c src/uvdb_rsp_frame.c src/uvdb_fileio_flow.c src/uvdb_memory_transaction.c src/uvdb_thread_control.c src/uvdb_console_transport.c src/uvdb_console.c src/uvdb_protocol_gate.c src/uvdb_exception_guard.c src/uvdb_exception_handlers.c src/uvdb_breakpoint_patch.c src/uvdb_exclusive_step.c src/uvdb_monitor.c src/uvdb_registers.c
	$(HOST_CC_RUN) $(HOST_CFLAGS) -ffunction-sections -fdata-sections -Itests/host tests/host/test_uvdb_core_integration.c src/uvdb_rsp.c src/uvdb_rsp_frame.c src/uvdb_fileio_flow.c src/uvdb_memory_transaction.c src/uvdb_thread_control.c src/uvdb_console_transport.c src/uvdb_console.c src/uvdb_protocol_gate.c src/uvdb_exception_guard.c src/uvdb_exception_handlers.c src/uvdb_breakpoint_patch.c src/uvdb_exclusive_step.c src/uvdb_monitor.c src/uvdb_registers.c -Wl,--gc-sections -o $@
